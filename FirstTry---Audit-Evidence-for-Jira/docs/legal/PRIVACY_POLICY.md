...
- Email: Request deletion at privacy@firsttry.run (48-hour response)
...
**Request:** Email privacy@firsttry.run
...
**How:** Modify snapshots in FirstTry dashboard or email privacy@firsttry.run
...
**How:** Uninstall app (immediate deletion) or email privacy@firsttry.run
...
**How:** Email privacy@firsttry.run
...
**Request:** Uninstall app or email privacy@firsttry.run
...
**Parents/Guardians:** Email privacy@firsttry.run if you believe your child's data was collected.
