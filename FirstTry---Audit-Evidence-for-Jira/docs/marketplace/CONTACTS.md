...
**Organization:** FirstTry Solutions  
...
| Contact Type | Expected Response Time |
|--------------|----------------------|
| Support (General) | 2 business days |
| Support (Critical) | 24 hours |
| Security (Critical) | 1 hour |
| Security (High) | 3 business days |
...
**This file is the single source of truth for all FirstTry Solutions contact information used in marketplace documentation.**
