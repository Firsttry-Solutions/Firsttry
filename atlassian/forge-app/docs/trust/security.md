...
**Offline source scan (as of 2026-03-02):** Detected 20 external URL literal(s) in src/ (see evidence: /tmp/ft_marketplace_trustfacts_20260302T093515Z_27339/verifiers/01_scan/runtime_urls.txt).
