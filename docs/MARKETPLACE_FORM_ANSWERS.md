...
| **16** | Does your app have customer support / security contact? | **YES** | Support is community-basis via repository GitHub issues; security issues can be reported to security@firsttry.run (if available); response time: 30 days (GDPR requirement). | [PRIVACY.md:L139-L149](PRIVACY.md#L139-L149) |
...
### Security Issues
**Reporting**: security@firsttry.run (if available; check README for current contact)  
...
### Privacy Requests
**Data Subject Requests** (GDPR): email privacy@firsttry.run  
...
| **Last Updated** | 2026-01-13 |
| **Review Date** | Q1 2026 |
| **Change Control** | All deviations require security@firsttry.run approval + change request |
...
4. **For Deviations**: Any change to an answer must be:
   - Approved by security@firsttry.run
...
**Questions?** Contact security@firsttry.run or review the source documentation:
