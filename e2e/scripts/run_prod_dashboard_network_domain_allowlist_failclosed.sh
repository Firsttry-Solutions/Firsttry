...
# ============================================================================
# run_prod_dashboard_network_domain_allowlist_failclosed.sh
#
# Fail-closed runner for network domain allowlist proof gate.
# Validates that production dashboard only contacts allowed Atlassian domains.
# ============================================================================

readonly SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
readonly REPO_ROOT="$(cd "${SCRIPT_DIR}/../.." && pwd)"
readonly TEST_FILE="${REPO_ROOT}/e2e/tests/prod_dashboard_network_domain_allowlist.spec.ts"
readonly EVIDENCE_BASE="/tmp"
readonly EVIDENCE_PREFIX="ft_dashboard_domain_allowlist_run_"
...
# ============================================================================
# Copy test evidence to runner directory
# ============================================================================

log_info "Copying test evidence..."
...
log_info "Network domain allowlist gate PASSED"
