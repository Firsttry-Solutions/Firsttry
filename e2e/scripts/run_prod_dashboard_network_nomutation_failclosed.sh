...
# ============================================================================
# run_prod_dashboard_network_nomutation_failclosed.sh
# 
# Fail-closed runner for runtime non-mutation proof gate.
# Executes Playwright test that captures network traffic and validates no
# Jira mutations occur during prod dashboard smoke run.
# ============================================================================

readonly SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
readonly REPO_ROOT="$(cd "${SCRIPT_DIR}/../.." && pwd)"
readonly TEST_FILE="${REPO_ROOT}/e2e/tests/prod_dashboard_network_nomutation.spec.ts"
readonly EVIDENCE_BASE="/tmp"
readonly EVIDENCE_PREFIX="ft_dashboard_nomutation_run_"
...
for file in final_url.txt host.txt path.txt methods_seen.txt mutation_hits.txt SUCCESS.txt; do
...
log_info "Runtime non-mutation proof gate PASSED"
