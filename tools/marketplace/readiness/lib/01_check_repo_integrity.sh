...
require_dir "$REPO_ROOT/atlassian/forge-app"

# Check package-lock.json exists
require_file "$REPO_ROOT/atlassian/forge-app/package-lock.json"
...
ls -la "$REPO_ROOT/atlassian/forge-app" > "$PHASE_DIR/tree_forge_app.txt" 2>&1 || true
